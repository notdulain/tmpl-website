      ...
      <header className="sticky top-0 bg-light-white border-b border-light-grey">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center gap-6">
            <Link href="/home" className="text-charcoal-500 hover:text-maroon-500 hover:underline transition-colors">
              Home
            </Link>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <Link href="/home" className="text-charcoal-300 hover:text-maroon-500 transition-colors">
                Home
              </Link>
